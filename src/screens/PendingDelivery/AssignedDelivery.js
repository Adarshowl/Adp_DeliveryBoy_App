...
const AssignedDelivery = ({ navigation }) => {
        ...
        try {
            ...
            ApiCall('post', body, API_END_POINTS.orderstatusupdate, {
                ...
                if (response?.data?.status == true) {
                    ...
                    navigation.navigate('PickedList');
                    ShowToastMessage("delivery is pickedup", response?.data?.success);
    ...
    const pendingRenderItem = ({ item }) => {
        ...
        // console.log(item?.orderId?.is_cancelled)
        console.log('item',item)
                ...
                {dashboard.length !== 0 && (
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Image
                                source={{ uri: 'https://cdn-icons-png.flaticon.com/128/763/763965.png' }}
