...
const Order = ({ navigation, route }) => {
  ...
  console.log(" Product", address?.userId?.name)
      ...
      >
        ...
        <View style={{
          ...
          <View style={{
            ...
            {dashboard?.orderId?.delivery_status === 'Delivered' ||
              dashboard?.orderId?.delivery_status === "On The Way" ||
              dashboard?.orderId?.delivery_status === 'Shipped' ||
              dashboard?.orderId?.delivery_status === 'Pending'
              ? (
                <Image
                  source={{
            ...
            {dashboard?.orderId?.delivery_status === 'Delivered' ||
              dashboard?.orderId?.delivery_status === "On The Way" || dashboard?.orderId?.delivery_status === 'Shipped' ? (

              <View
                style={{
                  width: '18%',
                  height: 5,
                  backgroundColor: COLORS?.righticonColor,
                  alignSelf: 'center',
            ...
            {dashboard?.orderId?.delivery_status === 'Delivered' || dashboard?.orderId?.delivery_status === "On The Way" ? (
          ...
          <View style={styles?.detailsView}>
            ...
            <View style={styles?.viewtext}>
              <View style={{
                ...
                {/* <Text style={styles?.normalLeft}>City: {address?.userId?.city}</Text> */}
