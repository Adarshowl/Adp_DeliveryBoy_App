...
export const splash = require('../assets/images/adp_Splash.jpg');
...
export const intro_c = require('../assets/images/intro/vendor3.png');
export const offer_bg = require('../assets/images/offer_bg.jpg');
...
export const new_splash = require('../assets/images/new_splash.jpeg')



export default {new_splash,
  bg_no_item_cactus,
  splash,
  intro_a,
  intro_b,
